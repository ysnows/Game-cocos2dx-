...
#include <vector>
//the following header is for std::min function definition
#include <algorithm>
...
//------------------------------------------------------
//2013.2.17 added  by Xianzhong Zhu
//
//------------------------------------------------------

//bool SQLiteDatabase::openEncrypt(const char* dbPath, const void* password, int lenPass)
//{
//	std::string otherPath(dbPath);
//	if (otherPath.empty())
//	{
...
//		return false;
//	}
//	//++encrypt for the first time use or input password to open the encrypted database
//	err = sqlite3_key(_db, password, lenPass);
//	if(err != SQLITE_OK) 
//	{
//		return false;
//	}
...
//	return true;
//}
//bool SQLiteDatabase::openAndChangePassword(
//	const char* dbPath, 
...
//	}
//	//++encrypt for the first time use or input password to open the encrypted database
//	err = sqlite3_key(_db, oldPassword, lenOldPass);
//	if(err != SQLITE_OK) 
//	{
//		//CCLog("First key error!");
//		return false;
//	}
//	err = sqlite3_rekey(_db, newPassword, lenNewPass);
//	if(err != SQLITE_OK) 
//	{
//		//CCLog("Rekey error!");
//		return false;
